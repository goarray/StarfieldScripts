unit ReplaceSecondSetBlockPatternsFromCSV;
...
begin
  ...
  SurfaceSet := ElementByIndex(SurfaceData, 1); // Target the second Surface Pattern set
  ...
  try
    FormIndex := 0;
    for j := StartIndex to count - 1 do begin
